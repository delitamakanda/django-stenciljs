...
class InterestedInGender(models.Model):
    user_account = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE)
...
class Grade(models.Model):
    user_account_given = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, related_name='grade_given', on_delete=models.CASCADE)
    user_account_received = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, related_name='grade_received', on_delete=models.CASCADE)
...
class BlockUser(models.Model):
    user_account = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, related_name='rel_to_from', on_delete=models.CASCADE)
    user_account_blocked = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, related_name='rel_to_set', on_delete=models.CASCADE)
